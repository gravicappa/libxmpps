...
int xml_insert(int x, const char *name, struct pool *p);
int xml_node_add_attr(int node, const char *id, const char *value,
                      struct pool *p);
int xml_node_add_text(int node, const char *text, struct pool *p);
int xml_node_add_text_id(int node, int text, struct pool *p);
int xml_node_add_textn(int node, int len, const char *text, struct pool *p);

struct xml_data *xml_node_data(int node, struct pool *p);
struct xml_data *xml_data_next(struct xml_data *d, struct pool *p);
char *xml_node_find_attr(int node, const char *name, struct pool *p);
...
int xml_printfv(struct pool *pool, int h, const char *fmt, va_list args);
